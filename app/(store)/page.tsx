      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-amber-50/60 via-white to-white dark:from-zinc-950 dark:via-zinc-950 dark:to-zinc-950 px-4 py-28 text-center">
        ...
        <div className="relative">
          ...
          <p className="mt-6 max-w-xl mx-auto text-lg text-zinc-500 dark:text-zinc-400 leading-relaxed">
            Browse premium apparel, mugs, and accessories — or upload your own artwork and create something uniquely yours.
          </p>
          ...
          {[
            {
              ...
              body: "Upload your artwork or use our in-browser editor to craft something truly yours.",
            ...
            },
            {
              icon: Truck,
              title: "Fast Delivery",
              body: "Every order is handled with care and shipped directly to your door.",
              color: "text-blue-500",
            ...
            },
            {
              ...
              body: "Premium materials and print-ready processes — your order will look great.",
      ...
      {featuredProducts.length > 0 && (
        <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6">
          <div className="flex items-end justify-between mb-8">
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-amber-500 mb-1">Latest drops</p>
              <h2 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">New Arrivals</h2>
            </div>
            <Link
              href="/products"
